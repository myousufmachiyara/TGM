...
class PurFGPOController extends Controller
{
    ...
    public function print($id)
    {
       ...
       ';
        ...
        foreach ($purpos->details as $item) {
            ...
            if ($product->attachments->isNotEmpty()) {
                ...
                if (file_exists($imagePath)) {
                    $pdf->Image($imagePath, '', '', 60, 80, '', '', '', false, 300, '', false, false, 0, false, false, false);
        ...
        // Header
        $pdf->writeHTML('<h1 style="font-size:20px;text-align:center;font-style:italic;text-decoration:underline;color:#17365D">Fabric Challan</h1>',true, false, true, false, '');
